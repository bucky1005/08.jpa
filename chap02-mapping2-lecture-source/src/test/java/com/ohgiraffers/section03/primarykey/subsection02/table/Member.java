...
@TableGenerator(
        name = "memnber_seq_table_generator",
...
public class Member {
    ...
    @GeneratedValue(strategy = GenerationType.TABLE, generator = "memnber_seq_table_generator")
    ...
    @Column(name="phone", columnDefinition = "varchar(200) default '010-0000-1232'")
    private String phone;

    @Column(name="email", unique = true)            // Unique 제약조건 설정
    private String email;

    @Column(name="address", nullable = false)       // NotNull 제약조건 설정
