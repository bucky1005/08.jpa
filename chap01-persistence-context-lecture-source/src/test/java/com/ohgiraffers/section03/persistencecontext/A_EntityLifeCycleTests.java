...
//        System.out.println("foundMenu = " + foundMenu);
    ...
    public void 영속성_객체_추가_테스트() {
         ...
         *  @GeneratedValue부분을 주석하고 테스트를 작성하자.
         * */
...
//        entityManager.clear();        // 영속 상태인 것들을 모두 비워버림(비영속 상태로 바꿈)

        /* 설명. 영속성 컨텍스트 및 엔티티 매니저까지 종료해버린다.(사용 불가) */
        entityManager.close();          // 영속 상태인 것들의 stream을 닫아줌
    ...
    public void 병합_merge_삽입_테스트() {
        ...
        assertNotEquals(mergedMenu.getMenuCode(), newMenu.getMenuName());
